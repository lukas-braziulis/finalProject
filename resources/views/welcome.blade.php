...
{{--                        <a href="{{ url('/profile') }}" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">User Profile</a>--}}
{{--                    @else--}}
...
{{--                <button class="btn btn-outline-primary"><a href="/directors">Movies by Directors</a></button>--}}
{{--                <button class="btn btn-outline-primary"><a href="/years">Movies by Years</a></button>--}}
{{--        </div>--}}
{{--    </body>--}}
{{--</html>--}}
